...
import com.pharari.thiago.marketmap.databinding.ActivitySeleccionarUbicacionBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.IbGsp.setOnClickListener {
            if (esGpsActivado()){
                ...
                Toast.makeText(this, "¡La ubicación no está activada!. Es necesario para mostrar la ubicación actual",Toast.LENGTH_SHORT).show()
            }
        }
